...
public struct BinaryData : ExpressibleByArrayLiteral {
  ...
  public func get(_ offset: Int, bigEndian: Bool? = nil) throws -> UInt16 {
    ...
    /**
     Parse `UInt24` from underlying data.
     
     - parameter offset: Offset in bytes from this value should be read
     - parameter bigEndian: Is data in big-endian or little-endian order? If this parameter may is ommited, than `BinaryData`
     setting is used.
     
     - returns: `UInt24` representation of byte at offset.
     - throws: `BinaryDataErrors.NotEnoughData` if there is not enough data.
     */
    public func get(_ offset: Int, bigEndian: Bool? = nil) throws -> UInt24 {
      guard offset + 2 < data.count else { throw BinaryDataErrors.notEnoughData }
      return UInt24.join((data[offset], data[offset + 1], data[offset + 2]),
                         bigEndian: bigEndian ?? self.bigEndian)
    }
...
//    /**
//     Parse `Int24` from underlying data.
//
//     - parameter offset: Offset in bytes from this value should be read
//     - parameter bigEndian: Is data in big-endian or little-endian order? If this parameter may is ommited, than `BinaryData`
//     setting is used.
//
//     - returns: `Int24` representation of byte at offset.
//     - throws: `BinaryDataErrors.NotEnoughData` if there is not enough data.
//     */
//    public func get(_ offset: Int, bigEndian: Bool? = nil) throws -> Int24 {
//        let uint:UInt24 = UInt24(try get(offset, bigEndian: bigEndian ?? self.bigEndian))
//      return Int24(bitPattern: uint)
//    }
